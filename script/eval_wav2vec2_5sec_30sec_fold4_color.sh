...
do
    for m in $MODEL
    do
        TAG="bs32_lr5e-5_ep50_seed${s}_fold4_30sec_color"
        CUDA_VISIBLE_DEVICES=1 python main.py --tag $TAG \
                                        ...
                                        --save_name wav2vec2 \
                                        --eval \
                                        --pretrained_ckpt ./save/psychiatry_microsoft/wavlm-base-plus_ce_bs32_lr5e-5_ep50_seed1_fold4_30sec_color/best.pth
